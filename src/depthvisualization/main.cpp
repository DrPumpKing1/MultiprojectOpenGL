...
int main(void)
{
    ...
    Shader modelShader("default.vs", "depthvisualization.fs");
	...
	Shader asteroidShader("instancing.vs", "depthvisualization.fs");
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
	    ...
	    projection = glm::perspective(glm::radians(camera.Zoom), (float)CURR_WIDTH / (float)CURR_HEIGHT, nearPlane, farPlane);
		glBindBuffer(GL_UNIFORM_BUFFER, uboMatrices);
		glBufferSubData(GL_UNIFORM_BUFFER, 0, sizeof(glm::mat4), glm::value_ptr(projection));
        ...
        */
        ...
        modelShader.setFloat("far", farPlane);
        modelShader.setFloat("near", nearPlane);
        ...
        */
        ...
        asteroidShader.setFloat("far", farPlane);
        asteroidShader.setFloat("near", nearPlane);
