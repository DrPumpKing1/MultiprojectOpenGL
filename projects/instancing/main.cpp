...
int main(void)
{
    ...
    std::string resourcesFolder = (fs::current_path()).string() + "\\resources\\";
    std::string shadersFolder = resourcesFolder + "shaders\\";
	std::string texturesFolder = resourcesFolder + "textures\\";
	std::string cubemapsFolder = resourcesFolder + "cubemaps\\";
    std::string modelPath = resourcesFolder + "models\\backpack\\backpack.obj";
    std::string jupiterModelPath = resourcesFolder + "models\\planet\\planet.obj";
    std::string asteroidModelPath = resourcesFolder + "models\\rocks\\rock_001.obj";
	std::string transparentTexturePath = texturesFolder + "window.png";

    //Building and compiling our shader program
    Shader modelShader((shadersFolder + "default.vert").c_str(), (shadersFolder + "default.frag").c_str());
    Shader postprocessShader((shadersFolder + "postprocess.vert").c_str(), (shadersFolder + "postprocess.frag").c_str());
	Shader transparentShader((shadersFolder + "transparent.vert").c_str(), (shadersFolder + "transparent.frag").c_str());
	Shader skyboxShader((shadersFolder + "skybox.vert").c_str(), (shadersFolder + "skybox.frag").c_str());
    Shader normalVisualizationShader((shadersFolder + "normalvisualization.vert").c_str(), (shadersFolder + "normalvisualization.frag").c_str(), (shadersFolder + "normalvisualization.geom").c_str());
	Shader asteroidShader((shadersFolder + "instancing.vert").c_str(), (shadersFolder + "default.frag").c_str());

    //Loading models
    Model defaultModel(jupiterModelPath.c_str());

	//Loading textures
	Texture transparentTexture(transparentTexturePath.c_str(), "diffuse", 0, true);
    ...
    */
    Skybox skybox(
        (cubemapsFolder + "Galaxy\\right.png").c_str(),
        (cubemapsFolder + "Galaxy\\left.png").c_str(),
        (cubemapsFolder + "Galaxy\\top.png").c_str(),
        (cubemapsFolder + "Galaxy\\bottom.png").c_str(),
        (cubemapsFolder + "Galaxy\\front.png").c_str(),
        (cubemapsFolder + "Galaxy\\back.png").c_str(),
        4
    );
    ...
    Model asteroids(asteroidModelPath.c_str(), instances, instancesModelMatrices);
	...
	glUniformBlockBinding(skyboxShader.ID, uniformBlockIndexModel, 0);
